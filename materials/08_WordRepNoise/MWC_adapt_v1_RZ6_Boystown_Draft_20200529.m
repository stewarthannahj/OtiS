...
while not(TRACK.EndTrack),
    ...
    [player1,player2]=UpdateMaskLev(yarray1,yarray2,Fs1,Fs2,speakerIDMask,TRACK,ti1,ti2,STIM);
...
%------------------------------------------------------------------%
function [player1,player2]=UpdateMaskLev(y1,y2,Fs1,Fs2,speakerIDMask,TRACK,ti1,ti2,STIM)
...
yarray(:,1) = y;
SigScale = (10^(STIM.TargetSigLev/20))/(10^(65/20));
%SigScale = 1
