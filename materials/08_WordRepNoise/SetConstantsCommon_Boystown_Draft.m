function [IO,STIM]=SetConstantsCommon_Boystown_Draft  %NEED TO UPDATE THIS FXN

IO.Root='Z:\CSRC\Dave_Moore-Project_Library-2014\Tasks\BoysTown\matlab_1speaker\';      % this may need to be customized
...
STIM.MaskerConditionStr={'Experiment 1', 'Experiment 2', 'Experiment 3'};              %%Changed from original Oticon Script
STIM.TargetSigLev=65;       % Computer volume needs to be set to 50 for speakers 1, 5, 6, 7
...
% TARGET LEVEL HERE
STIM.MaxSigLev=80;		% level of calibration tone (equal RMS to stim)7/12/13
...
%MASKER LEVEL HERE
STIM.MaxMaskerLev=80;    %level of calibration tone (from masker) 7/12/13
                            %LJL changed cal level to 82 dB SPL on 3-12-14
                            %LJL changed cal level to 76 dB SPL on 8-9-14 to
                        %reflect rack changes for other programs
                        %8/19/14 AYB changed so we could run stimuli
